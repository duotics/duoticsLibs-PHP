<?php 
/* Generate Page Header Bootstrap 5
v.0.1 - 20210504 - initial code
*/
function genHeader($MOD=null, $tip='card', $cont=NULL, $floatR=NULL, $floatL=NULL, $css='mb-2', $tag='h1'){//duotics_lib->v.0.11
	$ret=null;
	$retMod=null;
	switch($tip){
		case 'card':
